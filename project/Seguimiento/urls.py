...
from .views import RegistrarSeguimientoView, tiene_seguimiento, ObtenerSeguimientoView
...
urlpatterns = [
    ...
    path('obtener/', ObtenerSeguimientoView.as_view(), name='obtener_seguimiento'),
]
