...
class Embrion(models.Model):
	...
	pgt = models.CharField(max_length=20, choices=[("exitoso", "Exitoso"), ("no_exitoso", "No Exitoso")], default="no realizado", help_text="Resultado del PGT", blank=True, null=True)
